...
class MainMdlAdapter : RecyclerView.Adapter<MainMdlAdapter.MainMdlViewHolder>() {
    ...
    class MainMdlViewHolder(private val binding: Matrix9Binding,var mandalartData: MandalartData) : RecyclerView.ViewHolder(binding.root) {
        @SuppressLint("SetTextI18n")
        fun bind(m9Data: Matrix9Data) {
            val subMdlAdapter = SubMdlAdapter()

            subMdlAdapter.mandalartData = mandalartData
